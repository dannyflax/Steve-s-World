...
public class ModelControl
{
	...
	public ArrayList<Vertex> drawModel(Vertex pos, GL2 gl, float rangle, flaxapps.Vertex scale){
		//Drawing code, uses the model data to send GL commands to the given OpenGL object
 ...
 public void loadModelData(String name)
 {
	 ...
	 ArrayList<String> lines = new ArrayList<String>();
            ...
            InputStream in = null;
            try {
				in = getClass().getResource(name).openStream();
			} catch (NullPointerException e) {
				System.out.println("ERROR 1: Unable to find " + name);
				e.printStackTrace();
			} catch (IOException e) {
				e.printStackTrace();
			}
                 ...
                 try {
					...
					System.out.println("ERROR 2: Unable to read " + name);
					e.printStackTrace();
				}
